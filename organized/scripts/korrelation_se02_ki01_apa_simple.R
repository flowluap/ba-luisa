...
# Einfache Tabelle mit ggplot2 erstellen
...
# Tabelle als ggplot2 erstellen
p_table <- ggplot(table_data, aes(x = 1, y = 1)) +
  annotate("table", x = 1, y = 1, label = list(table_data)) +
  theme_void() +
  theme(
...
# Tabelle speichern
ggsave("../output/images/korrelation_se02_ki01_tabelle.png", p_table, 
...
cat("\n=== APA-TABELLE ERFOLGREICH ERSTELLT ===\n") 