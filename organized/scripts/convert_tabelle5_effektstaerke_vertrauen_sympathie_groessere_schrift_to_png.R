...
cat("================================================================================\n")
cat("TABELLE 5: PNG-KONVERTIERUNG MIT GRÖSSERER SCHRIFTGRÖSSE (20PX)\n")
cat("================================================================================\n")
...
png_file <- "organized/images/clustering/tabelle5_effektstaerke_vertrauen_sympathie_groessere_schrift.png"
...
cat("\n📊 ZUSAMMENFASSUNG:\n")
cat("• Tabelle 5 erfolgreich zu PNG konvertiert\n")
