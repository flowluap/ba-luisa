# ================================================================================
# KI02 MITTELWERTTABELLE
# ================================================================================
# Script zur Erstellung einer APA-formatierten Tabelle mit Mittelwerten
# für KI02 Items (KI02_01 bis KI02_08) pro Gruppe (KI vs. Mensch).
...
# Calculate means for KI02 items by group
table_data_calculated <- data %>%
  group_by(AB01) %>%
  summarise(
    n = n(),
    KI02_01_mean = round(mean(KI02_01, na.rm = TRUE), 2),
    KI02_02_mean = round(mean(KI02_02, na.rm = TRUE), 2), 
    KI02_03_mean = round(mean(KI02_03, na.rm = TRUE), 2),
    KI02_04_mean = round(mean(KI02_04, na.rm = TRUE), 2),
    KI02_05_mean = round(mean(KI02_05, na.rm = TRUE), 2),
    KI02_06_mean = round(mean(KI02_06, na.rm = TRUE), 2),
    KI02_07_mean = round(mean(KI02_07, na.rm = TRUE), 2),
    KI02_08_mean = round(mean(KI02_08, na.rm = TRUE), 2),
    .groups = 'drop'
  ) %>%
...
table_data <- data.frame(
  ...
  KI02_01 = c(
    round(mean(data$KI02_01[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_01[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_02 = c(
    round(mean(data$KI02_02[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_02[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_03 = c(
    round(mean(data$KI02_03[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_03[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_04 = c(
    round(mean(data$KI02_04[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_04[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_05 = c(
    round(mean(data$KI02_05[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_05[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_06 = c(
    round(mean(data$KI02_06[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_06[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_07 = c(
    round(mean(data$KI02_07[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_07[data$AB01 == 2], na.rm = TRUE), 2)
  ),
  KI02_08 = c(
    round(mean(data$KI02_08[data$AB01 == 1], na.rm = TRUE), 2),
    round(mean(data$KI02_08[data$AB01 == 2], na.rm = TRUE), 2)
  ),
...
ki02_apa_table <- create_apa_mean_table(table_data, "KI02 Mittelwerte")
...
# Save table as PNG with optimal dimensions (wider for more columns)
png("organized/images/descriptive/mean_table_KI02.png", 
    width = 2000, height = 200, res = 300, bg = "white")
grid::grid.newpage()
...
grid::grid.draw(ki02_apa_table)
popViewport()
dev.off()

cat("Tabelle für KI02 erstellt: mean_table_KI02.png\n")
...
cat("\n================================================================================\n")
cat("KI02-MITTELWERTTABELLE ERSTELLT (ECHTE DATEN):\n")
cat("================================================================================\n")
cat("• mean_table_KI02.png (KI02: KI02_01 bis KI02_08)\n")
