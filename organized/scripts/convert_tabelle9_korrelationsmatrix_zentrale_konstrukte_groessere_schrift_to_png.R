...
cat("================================================================================\n")
cat("TABELLE 9: PNG-KONVERTIERUNG MIT GRÖSSERER SCHRIFTGRÖSSE\n")
cat("================================================================================\n")
...
png_file <- "organized/images/clustering/tabelle9_korrelationsmatrix_zentrale_konstrukte_groessere_schrift.png"
