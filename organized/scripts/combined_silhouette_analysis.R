# =============================================================================
# COMBINED SILHOUETTE ANALYSIS
# =============================================================================
# Erstellt kombinierte Silhouette-Analysen im gleichen Stil wie die Barplots
...
# =============================================================================
# CREATE CUSTOM SILHOUETTE PLOTS
# =============================================================================

# Function to create custom silhouette plot
create_silhouette_plot <- function(sil_data, title, colors = c("#E74C3C", "#3498DB", "#2ECC71")) {
  ...
  # Create custom plot
  p <- ggplot(sil_df, aes(x = sil_width, y = reorder(seq_along(sil_width), sil_width), 
                          fill = factor(cluster))) +
...
sil_plot_ki <- create_silhouette_plot(sil_ki, "KI-Gruppe")
sil_plot_mensch <- create_silhouette_plot(sil_mensch, "Mensch-Gruppe")

# =============================================================================
# COMBINE PLOTS
# =============================================================================

cat("=== KOMBINIERE PLOTS ===\n")

# Combine plots using gridExtra
combined_silhouette <- grid.arrange(
  sil_plot_ki, sil_plot_mensch,
  ncol = 2
)
...
# Save combined plot
ggsave("organized/images/clustering/combined_silhouette_analysis.png", 
       combined_silhouette, width = 14, height = 6, dpi = 300, bg = "white", 
       limitsize = FALSE)

cat("✓ combined_silhouette_analysis.png erstellt\n")
...
cat("\n================================================================================\n")
cat("COMBINED SILHOUETTE ANALYSIS COMPLETED\n")
cat("================================================================================\n")
cat("Generated files:\n")
cat("- organized/images/clustering/combined_silhouette_analysis.png\n")
...
cat("\nVorteile des kombinierten Plots:\n")
cat("- Konsistenter Style mit anderen Visualisierungen\n")
cat("- Direkter Vergleich zwischen den Gruppen\n")
