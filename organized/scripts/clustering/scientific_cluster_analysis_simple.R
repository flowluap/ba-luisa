# =============================================================================
# WISSENSCHAFTLICHE CLUSTER-ANALYSE (VEREINFACHT)
# =============================================================================
...
cat("================================================================================\n")
cat("WISSENSCHAFTLICHE CLUSTER-ANALYSE (VEREINFACHT)\n")
cat("================================================================================\n")
...
calculate_eta_squared <- function(anova_result) {
...
perform_scientific_clustering <- function(data, group_name, k = 3) {
  ...
  # Silhouette analysis
  sil <- silhouette(clusters, dist(cluster_analysis$data_scaled))
  ...
  for(var in variables) {
    ...
    cat(var, "F(", anova_summary[[1]]$Df[1], ",", anova_summary[[1]]$Df[2], ") =", 
        round(f_value, 3), 
        ", p =", round(p_value, 4),
        ", η² =", round(eta_sq, 3), "\n")
  }
...
cat("• Cluster-Validierung durchgeführt (Silhouette)\n")
