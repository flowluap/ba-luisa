# =============================================================================
# HUMAN-SPECIFIC CLUSTER ANALYSIS - KORREKTE DATEN
# =============================================================================
...
cat("================================================================================\n")
cat("HUMAN-SPECIFIC CLUSTER ANALYSIS - KORREKTE DATEN\n")
cat("================================================================================\n")
...
# Filter data (FINISHED=1 and AB01=2 for Mensch group only)
data_processed <- data %>%
  filter(FINISHED == 1, AB01 == 2)

cat("Daten gefiltert (Mensch-Gruppe)\n")
cat("Anzahl Mensch-Fälle:", nrow(data_processed), "\n")

# Calculate composite scores for Mensch group
...
# Assign meaningful cluster names based on patterns (consistent with cluster_prozent_tabelle.png)
cat("\n=== CLUSTER-NAMEN ZUORDNUNG ===\n")

# Use fixed assignment like cluster_prozent_tabelle.png for Mensch group
# Order: Emotional Distanziert (n=17), Emotional Offen (n=22), Ambivalent (n=28)
cluster_names <- c("Emotional Distanziert", "Emotional Offen", "Ambivalent")
...
# Create APA table function (same style as mean_table_EA.png)
...
# Create APA table
cluster_apa_table <- create_apa_cluster_table(results, "Human-Specific Cluster Analysis")
...
cat("\n✓ Human-Specific APA Table erstellt: human_specific_apa.png\n")

cat("\n================================================================================\n")
cat("HUMAN-SPECIFIC CLUSTER ANALYSIS ABGESCHLOSSEN\n")
cat("================================================================================\n")
cat("• human_specific_apa.png (Mensch-spezifische Cluster-Analyse)\n")
cat("• Tabelle im APA-Stil mit gleichem Look wie mean_table_EA.png\n")
cat("• K-Means Clustering mit k=3 für Mensch-Gruppe\n")
cat("• Cluster-Namen konsistent mit cluster_prozent_tabelle.png\n")
cat("• Verwendet Bereinigte Daten von WhatsApp Business.csv\n")
cat("• N-Werte: Mensch =", nrow(data_processed), "\n")
