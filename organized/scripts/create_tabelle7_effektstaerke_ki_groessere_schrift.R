...
cat("================================================================================\n")
cat("TABELLE 7: EFFEKTSTÄRKE UND SIGNIFIKANZANALYSE FÜR KI-WAHRNEHMUNG UND KI-KRITIK\n")
cat("================================================================================\n")
...
table_data <- data.frame(
  ...
  Cohens_d = c(0.130, 0.090),
  t = c(0.771, -0.500),
  p = c(0.442, 0.618),
  KI_Avatar_M = c(2.84, 3.50),
  KI_Avatar_SD = c(0.33, 0.23),
  KI_Avatar_KI = c("[2.76, 2.92]", "[3.45, 3.56]"),
  Mensch_M = c(2.80, 3.52),
  Mensch_SD = c(0.35, 0.24),
  Mensch_KI = c("[2.72, 2.88]", "[3.47, 3.58]"),
...
table <- gt(table_data) %>%
  tab_header(
    title = "Tabelle 7",
    subtitle = "Effektstärke und Signifikanzanalyse für KI-Wahrnehmung und KI-Kritik"
  ) %>%
  tab_spanner(
    label = "KI-Avatar",
...
cat("\n================================================================================\n")
cat("TABELLE 7 ERFOLGREICH ERSTELLT!\n")
cat("================================================================================\n")

cat("\n📊 ZUSAMMENFASSUNG:\n")
cat("• Effektstärke und Signifikanzanalyse für KI-Wahrnehmung und KI-Kritik erstellt\n")
