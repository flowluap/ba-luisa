...
# ================================================================================
# TABELLE 9: PEARSON-KORRELATIONSMATRIX DER ZENTRALEN KONSTRUKTE (ORIGINAL LAYOUT)
# ================================================================================

cat("================================================================================\n")
cat("TABELLE 9: PEARSON-KORRELATIONSMATRIX MIT ORIGINAL LAYOUT\n")
cat("================================================================================\n")
...
# Abkürzungen für Variablennamen (exakt wie im Original)
abbreviations <- c("MN", "VS", "EA", "ID", "KI01", "KI02")
...
for(j in 1:length(available_vars)) {
  table_data[[abbreviations[j]]] <- correlation_with_stars[, j]
}
