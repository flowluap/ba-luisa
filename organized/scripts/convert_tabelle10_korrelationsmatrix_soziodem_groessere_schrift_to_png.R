...
cat("================================================================================\n")
cat("TABELLE 10: PNG-KONVERTIERUNG MIT GRÖSSERER SCHRIFTGRÖSSE\n")
cat("================================================================================\n")
...
png_file <- "organized/images/clustering/tabelle10_korrelationsmatrix_soziodem_groessere_schrift.png"
...
cat("• Alle Korrelationskoeffizienten mit 2 Nachkommastellen\n")
