...
# ================================================================================
# TABELLE 9: PEARSON-KORRELATIONSMATRIX DER ZENTRALEN KONSTRUKTE (KORRIGIERT)
# ================================================================================

cat("================================================================================\n")
cat("TABELLE 9: PEARSON-KORRELATIONSMATRIX (KORRIGIERT)\n")
cat("================================================================================\n")
...
for(var in available_vars) {
  ...
  marked_values <- sapply(1:length(cor_values), function(j) {
    if(var_index == j) {
      return("1.00")  # Diagonale mit 2 Nachkommastellen
    } else {
...
cat("\n================================================================================\n")
cat("TABELLE 9: KORRELATIONSMATRIX KORRIGIERT ERSTELLT\n")
cat("================================================================================\n")

cat("\n📋 ZUSAMMENFASSUNG:\n")
cat("• Tabelle 9 mit ECHTEN Daten erstellt\n")
...
cat("\n⚠️  WICHTIG: Vorherige Tabelle 9 verwendete Beispieldaten!\n")
cat("Diese Version verwendet die echten Daten aus dem Datensatz.\n") 