...
# Ohne Linien zwischen den Zeilen
# ================================================================================
...
# Tabellendaten mit exakten Werten aus der HTML-Datei
...
cat("• Exakte Werte aus der HTML-Datei verwendet\n")
...
cat("• Keine Linien zwischen den Zeilen\n")
