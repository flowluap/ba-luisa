...
# Interaktionseffekte von Vorwissen auf die Zielvariablen (Ohne Linien zwischen Zeilen)
# ================================================================================
...
# HTML-Datei einlesen
html_file <- "organized/images/clustering/tabelle11_interaktionseffekte_vorwissen_ohne_linien.html"
...
png_file <- "organized/images/clustering/tabelle11_interaktionseffekte_vorwissen_ohne_linien.png"
...
cat("• Tabelle 11 ohne Linien zwischen den Zeilen ist jetzt als Bild verfügbar!\n") 